 ...
 * @since 1.4.4
 */
if ( ! function_exists( 'oceanwp_wishlist_icon_shortcode' ) ) {

	function oceanwp_wishlist_icon_shortcode() {
		global $yith_wcwl;
		...
		// Enqueue script
		wp_enqueue_script( 'oceanwp-woo-wishlist' );

		$html = '<div class="woo-wishlist-link wishlist-shortcode">';
			$html .= '<a href="'. esc_url( $yith_wcwl->get_wishlist_url() ) .'">';
				$html .= '<i class="fa fa-heart-o"></i><span class="owp-wishlist-count">'. yith_wcwl_count_products() .'</span>';
			$html .= '</a>';
		$html .= '</div>';
...
add_shortcode( 'oceanwp_wishlist_icon', 'oceanwp_wishlist_icon_shortcode' );
