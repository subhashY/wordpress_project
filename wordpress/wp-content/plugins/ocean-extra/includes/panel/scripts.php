...
class Ocean_Extra_Scripts_Panel {
	...
	private static function get_scripts() {
		...
		$scripts = array(
			...
			'oe_wooOffCanvas_style'         => array(
				...
				'type'      => 'css',
				'files'     => array(
					$tSass . 'woo/_woo-off-canvas.scss',
				),
				'condition' => OCEANWP_WOOCOMMERCE_ACTIVE,
			),
			'oe_wooMobileCart_style'         => array(
				...
				'type'      => 'css',
				'files'     => array(
					$tSass . 'woo/_woo-mobile-cart.scss',
				),
				'condition' => OCEANWP_WOOCOMMERCE_ACTIVE,
			),
	...
	public function update_scripts() {
		...
		$scripts = array_intersect_key( get_option( 'oe_scripts_settings' ), self::get_scripts() );
